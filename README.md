...
| strict      | Strict, Warn, Lax   | Warn     | When strict is enabled, any items in the program that do not match the regex will cause an error rather than a warning message.                                                                                                                                                                               |
